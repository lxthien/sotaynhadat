<div class="col2 fl">
    <div class="groupcol2">
        <div class="constructioncol2">
            <div class="titleconstructioncol2"><h1><a style="color: #000;" href="<?=$base_url.$this->lang->lang()?>/new-products"><?=lang('newproduct')?></a></h1></div>
            <?php $i=0; foreach($newproducts as $row): $i++; ?>
