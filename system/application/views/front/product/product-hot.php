<div class="col2 fl">
    <div class="groupcol2">
        <div class="constructioncol2">
            <div class="titleconstructioncol2"><h1><a style="color: #000;" href="<?=$base_url.$this->lang->lang()?>/hot-products"><?=lang('hotproducts')?></h1></a></div>
            <?php $i=0; foreach($hotproducts as $row): $i++; ?>
