                ...
                <div class="sreenboxnew" style="width:610px; float:left; margin-top:1px;">
                    ...
                    <div class="thongtin">
                       <strong>  <p style=" color:#cb0021; float:left;">
                        ...
                        <p style=" color:#333333; float:right; margin-right:14px;"><?=date('d/m',strtotime($row->created))?></p>
                    </div>
                </div>
            </div>
...
<div class="right">
    ...
    <div style="margin-top: 5px;" class="qc"><a target="_blank" href="<?=$row->link;?>"><img src="<?=$base_url.$row->image?>" /></a></div>
    <?php endforeach; unset($row); ?>
	...
	<div class="sreenboxtwen mt-15px" style="width:313px; float:left;">
        ...
        <div class="email-signup-mbnd">
            <p class="title-email-signup">Cập nhật xu hướng STND</p>
            <p class="info-mail-signup">Đăng ký để nhận bản tin thị trường mới nhất từ STND</p>
