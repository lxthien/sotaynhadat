...
<div class="left">
            ...
            <div class="sreentindb" style="width:610px; float:left; margin-bottom:1px;">
                <div class="sreentindb" style="width:610px; height:15px; ">
                    <div class="sreentieude" style=" height:15px; float:left; margin-right:3px; margin-left:20px; ">
                        <div class="tieude">
                            <h3><a style="color: #0A6D00; text-transform: uppercase;" href="<?=$base_url.$row->estatecatalogue->name_none.'/'.$row->estatecity->name_none.'/'.$row->title_none?>.html" title="<?=$row->title;?>">
                                <?=strlen($row->title) < 90 ? $row->title : cut_string($row->title, 90).'...';?>
                            </a></h3>
                        </div>
                    </div>
    ...
    <div class="tinrao">
        <div class="box-news-mod">
            <h1><span> Tin rao mới nhất</span></h1>
        </div>
        <div class="boxnew" style="width:590px; float:left;  margin-top:0px;">
            ...
            ?>
                <div class="<?= $i%2!=0 ? 'boxtinrao' : 'boxtinrao2'; ?>">
                    <div class="tieuderao">
                        <h3><a style="margin-left:20px; margin-top:8px; float:left;" href="<?=$base_url.$row->estatecatalogue->name_none.'/'.$row->estatecity->name_none.'/'.$row->title_none?>.html" title="<?=$row->title;?>">
                            <?=strlen($row->title) < 85 ? $row->title : cut_string($row->title, 85).'...';?>
                        </a></h3>
                    </div>
    ...
    <div align="justify" class="gioithieu" style="width:612px; height:110px; margin-left:15px; float:left; font-size:14px;">
        <p style="text-align:left;color:#5e5e5e;margin-top: 10px;line-height: 18px;font-size: 14px;">
            Bạn đang xem kênh thông tin mua bán và <a style="color: #0078cc;"  href="http://sotaynhadat.vn/nha-dat-cho-thue" title="cho thuê nhà đất">cho thuê nhà đất</a> Sotaynhadat.vn <p>
        <p style="color:#5e5e5e;letter-spacing: 0.7px;line-height: 18px;">Sotaynhadat.vn là trang chuyên về thông tin cho thuê và <a style="color: #0078cc;" href="http://sotaynhadat.vn/nha-dat-ban" title="mua bán nhà đất">mua bán nhà đất</a> tại Việt Nam.<p>
        <p style="text-align: justify;color:#5e5e5e;line-height: 18px;">Bạn đang có nhu cầu về nhà đất? Bạn có thể nhanh chóng tìm thấy nhiều thông tin nhà đất tại
            đây. Để tiết kiệm thời gian hơn, bạn nên dùng công cụ tìm kiếm nhà đất của Chúng tôi. Hoặc tuyệt vời hơn, bạn có thể trực tiếp trải nghiệm!<br>
        </p>
    </div>
</div>
<style type="text/css">
...
<div class="right">
    ...
    <div class="sreenboxtwen" style="width:316px; float:left;">
        <div class="nhinrathegioi">
            <span class="title-top-box">Tiêu điểm trong tuần</span>
