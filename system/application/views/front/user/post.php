...
<div style="width:920px; float:left; border:1px solid #CCCCCC; height:auto; border-top:none; margin-bottom:15px; margin-left:9px; padding: 20px;">
    <div class="righttv" style="width:920px;margin-bottom:-16px;float:left;margin-left:0px;">
        <div style="width: 920px; margin: 0 auto;">
            ...
            <p style="text-align:center;color:#0000;margin-top:0px;font-size: 13px; line-height: 20px;">
                Để nổi bật hơn với khách truy cập, bạn cần chú ý cả phần hình thức và nội dung. </br>
                Đừng để tin rao của bạn đánh mất ấn tượng từ cái nhìn đầu tiên!
            </p> </br>
                    ...
                    <form class="form-register" id="frm-post" name="frmContact" method="post" action="<?= $base_url; ?>dang-tin"
                        ...
                        <div class="row-post">
                            <div class="area-post phaply">
                                <span class="rowLabel">Pháp lý: <span class="pl-required"
                                                                      style="display: inline-block; color: red;">(*)</span></span>
                                            <span class="rowInput">
                            ...
                            <div class="area-post-02">
                                <span class="rowLabel">Hướng: <span class="direction-required"
                                                                    style="display: inline-block; color: red;">(*)</span></span>
                                            <span class="rowInput">
                        ...
                        <div class="row-post depend-isprice">
                            ...
                            <div class="bettwen-price">
                                ...
                                <select class="price-type price-type-01" name="price_type" style="width: 100px;">
                                    ...
                                    <option <?= $o->price_type == 6 ? 'selected="selected"' : ''; ?> value="6">Nghìn/m2
                                    </option>
                                ...
                                <select class="price-type price-type-02" name="price_type_2" style="width: 100px; display: none;">
                                    <option <?= $o->price_type == 10 ? 'selected="selected"' : ''; ?> value="10">Nghìn/tháng
                                    </option>
                                    <option <?= $o->price_type == 11 ? 'selected="selected"' : ''; ?> value="11">Triệu/tháng
                                    </option>
                                    ...
                                    <option <?= $o->price_type == 14 ? 'selected="selected"' : ''; ?> value="14">Nghìn/m2/tháng
                                    </option>
                                    <option <?= $o->price_type == 15 ? 'selected="selected"' : ''; ?> value="15">Triệu/m2/tháng
                                    </option>
                                    <option <?= $o->price_type == 16 ? 'selected="selected"' : ''; ?> value="16">USD/m2/tháng
                                    </option>
                                </select>
                            </div>
                        ...
                        <span style="color: #5a5a5a; font-size: 12px;" class="rowLabel">(Tin rao có ảnh sẽ được xem nhiều gấp 10 lần và nhiều người gọi gấp 5 lần so với tin rao không có ảnh. Hình ảnh không vượt quá 1500 px mỗi chiều và dung lượng nhỏ hơn 2 MB.)</span>
                        <span> </span>
