...
<div class="linktop" style=" width:960px;height:20px; float:left; margin-top:12px; margin-bottom: 2px;">
    ...
    <div class="linkdautrang " style=" width:auto; float:left;"><a class="linkdautrang-active" href="<?php echo $base_url.'tin-tuc'; ?>">Tin Tức</a></div>
</div>
            ...
            <div style="float:right; width:195px; ">
                ...
                <div style="width:195px;margin-bottom:10px; float:right;">
                    <div class="hinhtintuctopcon">
                        <a href="<?=$base_url.'tin-tuc/'.$cat->name_none.'/'.$row->title_none?>.html" title="<?=strlen($row->title_vietnamese) < 100 ? $row->title_vietnamese: cut_string($row->title_vietnamese, 100).'...';?>">
            ...
            <div class="sreennoidungthitruong" style=" float:left; margin-top:6px; width:430px; margin-left:3px;">
                <div class="sreentieudethitruong" style="width:430px; float:right; margin-bottom:3px; margin-top:0px; ">
                    <div class="tieudenoibat2">
                        <a style="height: auto; width: 100%;" href="<?=$base_url?>tin-tuc/<?=$cat->name_none.'/'.$row->title_none?>.html" title="<?=$row->title_vietnamese;?>">
                ...
                <div style="width:430px; margin-bottom:8px;float:left;margin-top: 3px;">
                    <div style="float:left;">
                        <div class="linktinupdate"><a style="color: #109502;" href="<?php echo $base_url?>tin-tuc/<?=$cat->name_none; ?>" title="<?=$cat->name_vietnamese;?>"><p style="margin-left:12px;"><?=$cat->name_vietnamese;?></p></a></div>
                    </div>
            ...
            <div class="sreennoibat" style="width:300px;  margin-bottom:20px; float:right;">
                ...
                <div style=" width:180px; float:right; ">
                    <p class="tieudetinxemnhieu" style="margin-left:3px;">
                        <a href="<?=$base_url?>tin-tuc/<?=$cat->name_none.'/'.$row->title_none?>.html" title="<?=$row->title_vietnamese;?>"><?=$row->title_vietnamese;?></a>
                    </p>
                </div>
            </div>
            <?php endforeach; unset($row); ?>
