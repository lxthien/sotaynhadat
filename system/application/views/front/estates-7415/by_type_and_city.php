<div class="linktop" style=" width:600px;height:20px; float:left; margin-top:8px; margin-left:25px; margin-bottom:10px; ">
    ...
    <div class="link" style=" width:auto; float:left;"><a href="<?=$base_url.$type->estatecatalogue->name_none.'/'.$type->name_none; ?>" title="<?php echo $type->name;?>"><?php echo $type->name;?></a></div>
    <p style="float:left; margin-left:5px; margin-right:5px;">-</p>
    <div class="link" style=" width:auto; float:left;"><?=$city->name;?></div>
</div>
<!--main-->
