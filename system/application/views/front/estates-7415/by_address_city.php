<div class="linktop" style=" width:600px;height:20px; float:left; margin-top:8px; margin-left:25px; margin-bottom:10px; ">
    ...
    <div class="link" style=" width:auto; float:left;"><a href="<?=$base_url.$category->name_none.'-'.$city->name_none?>" title="<?php echo $city->name;?>"><?php echo $city->name;?></a></div>
</div>
<!--main-->
                    ...
                    <div class="sreentindb" style="width:610px; float:left; margin-bottom:1px;">
                        ...
                        <div class="sreenboxnew" style="width:610px; float:left; margin-top:1px;">
                            ...
                            <span class="style3" style="line-height: 15px;">
                                ...
                                <p style=" color:#6e6e6e; float:left; margin-left:20px;">Địa điểm: <span class="diadiem"><a href="<?php echo $base_url.$row->estatecatalogue->name_none.'-'.$row->estatedistrict->name_none.'/'.$row->estatecity->name_none; ?>"><?=$row->estatedistrict->name;?></a> </span></p>
