...
<div id="footer">
            <div id="credits">
            Power by <a href="mailto:mrvuongx@gmail.com">Vuong NTT</a>
            </div>
            <div id="styleswitcher">
                <ul>
                 	<li><a href="javascript: document.cookie='theme='; window.location.reload();" title="Blue" id="blueswitch">b</a></li>
