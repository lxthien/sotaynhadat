...
<form name="myform" id="myform" method="post" >
	...
	<table class="datatable" width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet" >
        ...
        <th width="39%"><div align="left">Name</div></th>
        <th width="10%"><div align="left">Value</div></th>
        <th width="12%"><div align="left">type</div></th>
        <th width="17%">Only Webmaster</th>
        <th width="18%"><div align="center">Tool</div></th>
      </tr>
     	<?php $arr=array();?>
        <?php $i=$this->uri->segment(5,0); foreach($configgroup as $row_group): $i++;?>
        	<tr >
                ...
                <td widtd="68%"></td>
                <td widtd="68%"></td>
                <td widtd="68%"><?php if($row_group->for_webmaster == 1) { ?><img src="<?=$base_url;?>images/admin/new/images/icons/action_check.gif" /><?php } ?></td>
                <td widtd="26%">
                  <div align="center">
                <?php 
            ...
            <tr >
                ...
                <td widtd="68%"><?php if($row->type !="password") echo $row->value; else echo "*****";?></td>
                <td widtd="68%"><div align="left"><?=$row->type;?></div></td>
                <td widtd="68%"><?php if($row->for_webmaster == 1) { ?><img src="<?=$base_url;?>images/admin/new/images/icons/action_check.gif" /><?php } ?></td>
                <td widtd="26%">
                  <div align="center">
                <?php 
