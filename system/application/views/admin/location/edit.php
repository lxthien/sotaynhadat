...
<form id="frmProduct" class="table_input" action="<?=$base_url;?>admin/locations/edit/<?=$object->id;?>" method="post" enctype="multipart/form-data">
...
<table class="table_input">
    <tr>
     	<td>
			<label for="name">Tên Locatons:<span style="color: red;">*</span></label></td>
        <td><input type="text"  name="name" class="smallInput big" value="<?=$object->name?>" /></td>
    </tr>
</table>
<!--end content tabs-->
