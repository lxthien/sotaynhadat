...
<form id="frmProduct" class="table_input" action="<?=$base_url;?>admin/experiences/edit/<?=$object->id;?>" method="post" enctype="multipart/form-data">
...
<table class="table_input">
    ...
    <tr>
     	<td>
			<label for="name">Tên kinh nghiệm (<?=$row->name?>):<span style="color: red;">*</span></label></td>
