    ...
    <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
		...
		<tbody>
            ...
            <tr>
                ...
                <td><a href="<?=$base_url?>admin/estatetypes/list_by_parent/<?=$row->id?>"><?=$row->name?></a></td>
                <td>
                    <?php
                        echo create_link_table('edit_icon',$base_url.'admin/estatecatalogues/edit/'.$row->id,'edit');
                    ?>
                </td>
            </tr>
            <?php
