    ...
    <div class="column"></div>
     <div class="portlet">
        ...
        <div class="portlet-content nopadding">
            <form action="<?=$base_url;?>admin/levels" method="post" >
                <div>
...
<div id="portlets">
    ...
    <div class="portlet">
    	...
    	<div class="portlet-content nopadding">
            <form name="myform" id="myform" method="post" action="<?=$base_url;?>admin/levels/updatePosition" >
               <?php $seg=$this->uri->segment(4,0);?>
            	<table class="datatable" width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet" >
                    <tr>
                        ...
                        <th width="50%"><div align="left">Tên trình độ</div></th>
                        <th width="10%"><div align="center">Position</div></th>
                        <th width="34%"><div align="center">Công cụ</div></th>
                    </tr>
                    <?php $i=0; foreach($levels as $row): $i++;?>
                    <tr style="cursor: pointer;" onclick="window.location.href = '<?=$this->admin_url.'levels/edit/'.$row->id;?>'">
                        ...
                        <td widtd="50%"><a href="<?=$this->admin_url.'levels/edit/'.$row->id;?>"><?php echo $row->name_vietnamese;?><span style="color:#9C3">(<?=get_from_datetime($row->created);?>)</span></a></td>
                        <td >
                        ...
                        <td widtd="34%">
                            <div align="center">
                            <?php 
            					echo create_link_table('edit_icon',$this->admin_url.'levels/edit/'.$row->id,'Edit News');
            					echo create_link_table('delete_icon',$this->admin_url.'levels/delete/'.$row->id,'delete','return confirm ("Bạn có muốn xóa đối tượng này không ?")'); ?>
                            </div>
                        </td>
                    </tr>	
                    <?php endforeach;?>
