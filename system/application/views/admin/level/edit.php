...
<form id="frmProduct" class="table_input" action="<?=$base_url;?>admin/levels/edit/<?=$object->id;?>" method="post" enctype="multipart/form-data">
...
<table class="table_input">
    ...
    <tr>
     	<td>
			<label for="name">Tên level (<?=$row->name?>):<span style="color: red;">*</span></label></td>
