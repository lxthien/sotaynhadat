...
<div style="width: 920px;margin:10px auto;">
    ...
    <div>Chào <?=$customer->name;?>!</div>
    <div>Bạn đã đặt hàng thành công ở website <a href="http://didongviet.vn" title="didongviet.vn">didongviet.vn</a>. Dưới đây là thông tin chi tiết
    về đơn hàng của bạn. Chúng tôi sẽ xử lý và liên hệ với bạn trong thời gian sớm nhất.</div>
