    ...
    $.fn.jPaginate = function(options) {
        ...
        return this.each(function() {
            ...
            function showPage(page) {
				...
				$('html, body').animate({
							scrollTop: $(".r_title_bg").offset().top
				}, 1000);
            }
            ...
            function createPagination(curr) {
			   ...
			   // end = "</ul>"
				...
				if(pagi_range.start >2)
				{
					items += '<li><a href="#" class="goto" title="1" >1</a><span style="font-weight:bold;">...</span></li>';
				}
				for (i=1;i<=number_of_pages;i++)
                {
...
((expiredays==null)?"":";expires="+exdate.toUTCString());
            ...
            $(".goto").live("click", function(e){
                ...
                $(".pagination").remove();
				var newcurr = parseInt($(this).attr("title"));
