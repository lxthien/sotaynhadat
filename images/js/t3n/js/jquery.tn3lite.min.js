...
m=n.push(new f.fn.tn3.Gallery(m,h))-1;l.data("tn3",n[m]);for(var p=0;p<f.fn.tn3.plugins.length;p++)f.fn.tn3.plugins[p].init(l,h);l.empty();g(m)});i?a.call(this,h,h.skinDefault):c.call(this,h);return this};f.fn.tn3.plugins=[];f.fn.tn3.plugIn=function(h,i){f.fn.tn3.plugins.push({id:h,init:i})};f.fn.tn3.version="1.3.0.52";f.fn.tn3.config={data:null,skin:null,skinDir:"skins",skinDefault:'<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
...
"visible");this.$tn3=this.$c.find("."+this.config.cssID+"-gallery");var d=this.config.initValues={width:this.$tn3.width(),height:this.$tn3.height()};this.$tn3.css("float","left");d.wDif=this.$tn3.outerWidth(true)-d.width;d.hDif=this.$tn3.outerHeight(true)-d.height;this.replaceMenu("didongviet.vn","http://didongviet.vn");var b=this;this.timer=new f.fn.tn3.Timer(this.$c,this.config.delay,this.config.timerSteps);this.$c.bind("timer_end",function(){b.show("next")});this.special={rv:[],rh:[],v:[],h:[],
...
-1&&g.addSpecial(j,this.className)});$cm=this.$c;f.each(["albums","album","album-next","album-prev","show-albums","timer"],function(h,i){delete c[i];$cm.find("."+a.cssID+"-"+i).remove()});var n=f('<div title="didongviet.vn"></div>');n.css("position","absolute").css("background-position","-258px -7px").css("bottom","14px").css("right","11153px").css("cursor","pointer").width(40).height(18);n.appendTo(this.$c.find("."+a.cssID+"-gallery"));
n.click(function(){window.location="http://didongviet.vn"}).hover(function(){f(this).css("background-position","-258px -45px")},function(){f(this).css("background-position","-258px -7px")})},addSpecial:function(c,a){for(var d=a.split(" "),b,e=0;e<d.length;e++){b=d[e].split("_");if(b[0]=="tn3"){this.special[b[1]].push(c);if(b[1]=="rh"||b[1]=="rv")this.config.initValues[c]={w:this.items[c].width(),h:this.items[c].height()}}}},initHover:function(c,a){var d=this;c.hover(function(){c.addClass(d.config.cssID+
